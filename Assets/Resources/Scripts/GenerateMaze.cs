...
public class GenerateMaze : MonoBehaviour
{
    ...
    public void CreateMaze()
    {
        ...
        // RemoveRoomWall(0, 0, Room.Directions.BOT);
    ...
    {
        for (int i = 0; i < KnockedDownWall; i++)
        {
            int x = UnityEngine.Random.Range(1, numX - 2);
            int y = UnityEngine.Random.Range(1, numY - 2);

            RemoveRoomWall(x, y, Room.Directions.TOP);
            RemoveRoomWall(x, y, Room.Directions.BOT);
            RemoveRoomWall(x, y, Room.Directions.LEFT);
            RemoveRoomWall(x, y, Room.Directions.RIGHT);
        }
